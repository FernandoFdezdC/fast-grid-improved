...
export class StringCell {
    constructor(id, offset, text) {
...
export class HeaderCell {
    constructor(id, offset, text, grid, index) {
        ...
        Object.defineProperty(this, "onHeaderClick", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: () => {
                const idx = this.grid.rowManager.view.sort.findIndex((sort) => sort.column === this.index);
        ...
        Object.defineProperty(this, "reuse", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (id, offset, text, index) => {
                this.id = id;
                this.index = index;
                this.setOffset(offset, true);
                this.setContent(text);
        ...
        Object.defineProperty(this, "syncToFilter", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: () => {
                const sort = this.grid.rowManager.view.sort.find((sort) => sort.column === this.index);
                if (sort == null) {
                    this.arrow.textContent = "";
                }
