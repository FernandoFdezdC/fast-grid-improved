...
class TimSort {
    constructor(array, compare) {
        ...
        Object.defineProperty(this, "minGallop", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: DEFAULT_MIN_GALLOPING
        });
        ...
        Object.defineProperty(this, "tmpStorageLength", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: DEFAULT_TMP_STORAGE_LENGTH
        });
        Object.defineProperty(this, "stackLength", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "runStart", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
 ...
 *     comparator.
 */
export async function sort(array, compare, shouldCancel) {
    let hi = undefined;
    let lo = undefined;
    ...
    do {
        ...
        if (ops % 4000 == 0) {
            await wait(0);
            if (shouldCancel()) {
                return { ok: false, error: "sorting-cancelled" };
            }
        }
        // Go find next run
        remaining -= runLength;
